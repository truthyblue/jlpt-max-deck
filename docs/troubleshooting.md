...
- 파일: `JLPT-MAX-Deck-1.2.0.apkg`
- 크기: 약 0.90GB
- SHA-256: `aea2e536f86f9dd4c5d43cf840386eb3c3e44a393d68dc889fd5bdea47041100`

macOS:

```bash
shasum -a 256 JLPT-MAX-Deck-1.2.0.apkg
```

Windows PowerShell:

```powershell
Get-FileHash .\JLPT-MAX-Deck-1.2.0.apkg -Algorithm SHA256
```

같은 v1.2.0의
[SHA256SUMS](https://github.com/truthyblue/jlpt-max-deck/releases/download/v1.2.0/SHA256SUMS)와
...
같은 v1.2.0의 빌더와 지원 PDF가 서로 맞지 않거나, PDF 표를 한자 골격과
...
문구, 사용한 v1.2.0, 운영체제와 멈춘 단계만 알려주세요.
