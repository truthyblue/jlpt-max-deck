...
- 크기: 약 1.17GB
- SHA-256: `c2415ba70882a09d14d5426af15e0e22229eb405a1d668b9f5234de7e3c1af89`

macOS:

```bash
shasum -a 256 JLPT-MAX-Deck-2.1.2.apkg
```

Windows PowerShell:

```powershell
Get-FileHash .\JLPT-MAX-Deck-2.1.2.apkg -Algorithm SHA256
```

같은 v2.1.2의
[SHA256SUMS](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.1.2/SHA256SUMS)와
...
같은 v2.1.2의 빌더와 지원 PDF가 서로 맞지 않거나, PDF 표를 한자 골격과
...
문구, 사용한 v2.1.2, 운영체제와 멈춘 단계만 알려주세요.
