...
- 파일: `JLPT-MAX-Deck-2.0.1.apkg`
- 크기: 약 1.12GB
- SHA-256: `fa1096e78d2675c6cf60e7078bbf9683482d2a0ec07a5659fb2bf0cb8d0ff7c1`

macOS:

```bash
shasum -a 256 JLPT-MAX-Deck-2.0.1.apkg
```

Windows PowerShell:

```powershell
Get-FileHash .\JLPT-MAX-Deck-2.0.1.apkg -Algorithm SHA256
```

같은 v2.0.1의
[SHA256SUMS](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.0.1/SHA256SUMS)와
...
같은 v2.0.1의 빌더와 지원 PDF가 서로 맞지 않거나, PDF 표를 한자 골격과
...
문구, 사용한 v2.0.1, 운영체제와 멈춘 단계만 알려주세요.
