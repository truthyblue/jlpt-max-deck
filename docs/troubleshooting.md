...
- 파일: `JLPT-MAX-Deck-2.0.0.apkg`
- 크기: 약 1.16GB
- SHA-256: `b72ee972a68183ade5923da7821bb29782c57a4f16e2ce3ec7d1bfdef436505d`

macOS:

```bash
shasum -a 256 JLPT-MAX-Deck-2.0.0.apkg
```

Windows PowerShell:

```powershell
Get-FileHash .\JLPT-MAX-Deck-2.0.0.apkg -Algorithm SHA256
```

같은 v2.0.0의
[SHA256SUMS](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.0.0/SHA256SUMS)와
결과가 다르면 파일을 삭제하고 안정적인 네트워크에서 다시 받으세요.

### 기본 덱에 `일상무따`가 없습니다

정상입니다. 기본 덱에는 문법·어휘·음성·실전 문제·참조표만 있습니다. 일상무따 한자는
필요한 학습자만 [별도 APKG로 만듭니다](build.md).

### 예상 수량과 다릅니다

처음 설치한 기본 덱은 노트 20,684개, 카드
39,004개, 미디어 24,978개입니다.
...
같은 v2.0.0의 빌더와 지원 PDF가 서로 맞지 않거나, PDF 표를 한자 골격과
...
문구, 사용한 v2.0.0, 운영체제와 멈춘 단계만 알려주세요.
