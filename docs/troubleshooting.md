...
- 파일: `JLPT-MAX-Deck-1.1.1.apkg`
- 크기: 약 0.87GB
- SHA-256: `0c6abfc969792e9129d67ccef30c2ca78d114a4cf7e06b187e0e4d05f8b5198f`

macOS:

```bash
shasum -a 256 JLPT-MAX-Deck-1.1.1.apkg
```

Windows PowerShell:

```powershell
Get-FileHash .\JLPT-MAX-Deck-1.1.1.apkg -Algorithm SHA256
```

같은 v1.1.1의
[SHA256SUMS](https://github.com/truthyblue/jlpt-max-deck/releases/download/v1.1.1/SHA256SUMS)와
...
같은 v1.1.1의 빌더와 지원 PDF가 서로 맞지 않거나, PDF 표를 한자 골격과
...
문구, 사용한 v1.1.1, 운영체제와 멈춘 단계만 알려주세요.
