...
- 같은 v2.1.2의 [JLPT-MAX-kanji-builder-2.1.2.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.1.2/JLPT-MAX-kanji-builder-2.1.2.zip)
...
- `build/kanji-addon/JLPT-MAX-kanji-addon-2.1.2.apkg`
...
1. `JLPT-MAX-Deck-2.1.2.apkg`를 먼저 가져옵니다.
2. 생성된 `JLPT-MAX-kanji-addon-2.1.2.apkg`를 같은 컬렉션에 가져옵니다.
3. `JLPT MAX덱::일상무따` 아래의 읽기·쓰기 덱을 확인합니다.
4. 합산 수량이 노트 25,324개, 카드
   43,641개, 미디어 27,827개인지 확인합니다.
