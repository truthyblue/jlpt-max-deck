...
- 같은 v1.2.0의 [JLPT-MAX-kanji-builder-1.2.0.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v1.2.0/JLPT-MAX-kanji-builder-1.2.0.zip)
...
- `build/kanji-addon/JLPT-MAX-kanji-addon-1.2.0.apkg`
...
1. `JLPT-MAX-Deck-1.2.0.apkg`를 먼저 가져옵니다.
2. 생성된 `JLPT-MAX-kanji-addon-1.2.0.apkg`를 같은 컬렉션에 가져옵니다.
