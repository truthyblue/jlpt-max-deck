...
- 같은 v2.0.3의 [JLPT-MAX-kanji-builder-2.0.3.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.0.3/JLPT-MAX-kanji-builder-2.0.3.zip)
...
- `build/kanji-addon/JLPT-MAX-kanji-addon-2.0.3.apkg`
...
1. `JLPT-MAX-Deck-2.0.3.apkg`를 먼저 가져옵니다.
2. 생성된 `JLPT-MAX-kanji-addon-2.0.3.apkg`를 같은 컬렉션에 가져옵니다.
