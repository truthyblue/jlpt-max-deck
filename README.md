...
| 구성 | 노트 | 카드 | 미디어 |
| --- | ---: | ---: | ---: |
| 기본 덱: 문법·어휘·음성·실전 문제·참조표 | 20,684 | 39,004 | 24,978 |
| 선택형 일상무따 한자 확장 | 4,674 | 4,674 | 14 |
| 두 APKG를 같은 컬렉션에 가져온 전체 | 25,358 | 43,678 | 24,992 |

기본 덱에는 문법 3,639개, 어휘 9,160개, 실전 문제
7,876개, 참조표 9개와
...
v2.0.0은 N5부터 N1까지 검토된 문법 3,639개를 더하고, 어휘를 9,160개로 늘리고 모든 어휘에 한국어→일본어 회상 카드를
