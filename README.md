...
| 원하는 구성 | 받을 파일 | 추가 준비물 |
| --- | --- | --- |
| 어휘·음성·실전 문제·참조표 | `JLPT-MAX-Deck-1.3.0.apkg` | Anki·AnkiMobile·AnkiDroid |
| 위 구성 + 일상무따 한자 | 기본 덱 + `JLPT-MAX-kanji-builder-1.3.0.zip` | 지원 PDF 2개, macOS 또는 Windows 컴퓨터 |

## 덱 구성

| 구성 | 노트 | 카드 | 미디어 |
| --- | ---: | ---: | ---: |
| 기본 덱: 어휘·음성·실전 문제·참조표 | 13,903 | 19,921 | 18,437 |
| 선택형 일상무따 한자 확장 | 4,674 | 4,674 | 14 |
| 두 APKG를 같은 컬렉션에 가져온 전체 | 18,577 | 24,595 | 18,451 |

기본 덱에는 어휘 6,018개, 실전 문제
7,876개, 참조표 9개와
단어·예문 음성이 들어 있습니다. 일상무따 한자
2,337개는 읽기·쓰기 노트
...
v1.3.0은 일상무따 한자마다 읽기 카드와 쓰기 카드를 따로 제공합니다. 기존
버전에서 업데이트할 때는 **기존 노트 업데이트를 `항상`**으로 선택하고, 가져오기가
끝나면 모든 기기에서 다시 전체 동기화하세요. 한자 확장은 v1.3.0 빌더로 다시
...
1. [1권 공식 자료 페이지](https://www.gilbut.co.kr/book/view?bookcode=BN003617)와
   ...
   지원 소책자 PDF를 각각 받습니다.
2. 같은 v1.3.0의
   [JLPT-MAX-kanji-builder-1.3.0.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v1.3.0/JLPT-MAX-kanji-builder-1.3.0.zip)을
   받아 압축을 완전히 풉니다.
...
5. 자동으로 열린 폴더의 `JLPT-MAX-kanji-addon-1.3.0.apkg`를
...
- 현재 자산과 검증 결과: [v1.3.0 릴리스 노트](docs/releases/v1.3.0.md)
