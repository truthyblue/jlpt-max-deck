...
| 원하는 구성 | 받을 파일 | 추가 준비물 |
| --- | --- | --- |
| 어휘·음성·실전 문제·참조표 | `JLPT-MAX-Deck-2.0.0.apkg` | Anki·AnkiMobile·AnkiDroid |
...
| 구성 | 노트 | 카드 | 미디어 |
| --- | ---: | ---: | ---: |
| 기본 덱: 어휘·음성·실전 문제·참조표 | 17,045 | 35,365 | 24,978 |
| 선택형 일상무따 한자 확장 | 4,674 | 4,674 | 14 |
| 두 APKG를 같은 컬렉션에 가져온 전체 | 21,719 | 40,039 | 24,992 |

기본 덱에는 어휘 9,160개, 실전 문제
7,876개, 참조표 9개와
...
v2.0.0은 어휘를 9,160개로 늘리고 모든 어휘에 한국어→일본어 회상 카드를
