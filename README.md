...
| 원하는 구성 | 받을 파일 | 추가 준비물 |
| --- | --- | --- |
| 어휘·음성·실전 문제·참조표 | `JLPT-MAX-Deck-1.1.1.apkg` | Anki·AnkiMobile·AnkiDroid |
| 위 구성 + 일상무따 한자 | 기본 덱 + `JLPT-MAX-kanji-builder-1.1.1.zip` | 지원 PDF 2개, macOS 또는 Windows 컴퓨터 |

## 덱 구성

| 구성 | 노트 | 카드 | 미디어 |
| --- | ---: | ---: | ---: |
| 기본 덱: 어휘·음성·실전 문제·참조표 | 13,903 | 20,065 | 18,253 |
| 선택형 일상무따 한자 확장 | 2,337 | 2,337 | 14 |
| 두 APKG를 같은 컬렉션에 가져온 전체 | 16,240 | 22,402 | 18,267 |
...
1. [1권 공식 자료 페이지](https://www.gilbut.co.kr/book/view?bookcode=BN003617)와
   ...
   지원 소책자 PDF를 각각 받습니다.
2. 같은 v1.1.1의
   [JLPT-MAX-kanji-builder-1.1.1.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v1.1.1/JLPT-MAX-kanji-builder-1.1.1.zip)을
   받아 압축을 완전히 풉니다.
...
5. 자동으로 열린 폴더의 `JLPT-MAX-kanji-addon-1.1.1.apkg`를
...
- 현재 자산과 검증 결과: [v1.1.1 릴리스 노트](docs/releases/v1.1.1.md)
