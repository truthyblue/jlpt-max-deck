...
| 원하는 구성 | 받을 파일 | 추가 준비물 |
| --- | --- | --- |
| 문법·어휘·음성·실전 문제·참조표 | `JLPT-MAX-Deck-2.1.1.apkg` | Anki·AnkiMobile·AnkiDroid |
| 위 구성 + 한자 읽기·쓰기 | 기본 덱 + `JLPT-MAX-kanji-builder-2.1.1.zip` | 지원 PDF 2개, macOS 또는 Windows 컴퓨터 |
...
1. [1권 공식 자료 페이지](https://www.gilbut.co.kr/book/view?bookcode=BN003617)와
   ...
   지원 소책자 PDF를 각각 받습니다.
2. 같은 v2.1.1의
   [JLPT-MAX-kanji-builder-2.1.1.zip](https://github.com/truthyblue/jlpt-max-deck/releases/download/v2.1.1/JLPT-MAX-kanji-builder-2.1.1.zip)을
   받아 압축을 완전히 풉니다.
...
5. 자동으로 열린 폴더의 `JLPT-MAX-kanji-addon-2.1.1.apkg`를
...
- 현재 자산과 검증 결과: [v2.1.1 릴리스 노트](docs/releases/v2.1.1.md)
