...
TEMPLATE_OUTPUTS: tuple[tuple[PurePosixPath, PurePosixPath], ...] = (
    ...
    (
        PurePosixPath("docs/releases/v2.0.3.md.j2"),
        PurePosixPath("docs/releases/v2.0.3.md"),
    ),
    (
        PurePosixPath("docs/releases/v2.1.0.md.j2"),
        PurePosixPath("docs/releases/v2.1.0.md"),
    ),
    (
        PurePosixPath("docs/releases/v2.1.1.md.j2"),
        PurePosixPath("docs/releases/v2.1.1.md"),
    ),
    (
        PurePosixPath("docs/releases/v2.1.2.md.j2"),
        PurePosixPath("docs/releases/v2.1.2.md"),
    ),
    (
