...
$ReleaseTag = "v1.0.0"
$ReleaseUrl = "https://github.com/truthyblue/jlpt-max-deck/releases/download/$ReleaseTag"
$OutputRoot = Join-Path $env:USERPROFILE "JLPT-MAX-public-release-$ReleaseTag"
$Suffix = [guid]::NewGuid().ToString("N").Substring(0, 6)
$DirectoryName = "JLPT-MAX-public-{0}-{1}" -f $ReleaseTag, $Suffix
$WorkRoot = Join-Path `
...
try {
    ...
    $BundleRoot = Join-Path $BuildRoot "public-bundle"
    $BuildScript = Join-Path $BundleRoot "scripts\build-public.ps1"
